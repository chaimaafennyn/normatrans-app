...
# =========================================
    ...
    st.header("Calcul des tarifs pondérés par agence et par zone")

    uploaded_file = st.file_uploader("repartition_par_agence_et_zone.csv", type=["csv"])
    ...
    if uploaded_file is not None:
        ...
        tarif_total = st.number_input("Tarif total (ex: 10€)", value=10.0)
